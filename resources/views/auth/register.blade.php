...
<div class="page-header header-filter" filter-color="purple" style="background-image: url('{{asset('img/bg7.jpg')}}')">
    <div class="container">
      <div class="row">
        <div class="col-md-5 ml-auto mr-auto">{{-- <div class="col-md-10 ml-auto mr-auto"> --}}
          <div class="card card-signup">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="mr-auto ml-auto text-center">{{-- <div class="col-md-5 mr-auto">  --}}
                  ...
                  <form class="form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Nombre..." name="name" value="{{ old('name') }}" required>
